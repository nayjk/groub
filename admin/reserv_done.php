...
if($result = $conn->query($sql)){
    ...
    foreach($result as $row){
		...
		echo "<tr>";
		echo "<td>
                    <form action='help/archive_reserv_done.php' method='post'>
            ...
            echo "<td class = marjin_left>
                    <form action='help/delete_done.php' method='post'>
                        <input type='hidden' name='id' value='" . $row["id"] . "' />
                        <input type='submit' value='Удалить'>
                    </form>
            </td>";
            echo "<td class = marjin_left><a href='help/upgrade_done.php?id=" . $row["id"] . "'>Обновить</a></td>";
        echo "</tr>";
    }
    echo "</table>";
	?> </div> <?php
