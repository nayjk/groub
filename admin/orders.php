	...
	<div class="wrapper">
		...
		<div class="content">
			<article class="main-article">
				...
				<a class="big dungeon_text10"> Заказы (готовятся) </a>
				<!-- вывод таблицы готовящихся заказов orders -->
				<?php
...
if($result = $conn->query($sql)){
    ...
    foreach($result as $row){
		...
		echo "<tr>";
		echo "<td>
                    <form action='help/archive_orders_old.php' method='post'>
            ...
            echo "<td class = marjin_left>
                    <form action='help/delete_orders.php' method='post'>
                        <input type='hidden' name='id' value='" . $row["id"] . "' />
                        <input type='submit' value='Удалить'>
                    </form>
            </td>";
            echo "<td class = marjin_left>
                    <form action='help/delivery_1.php' method='post'>
                        <input type='hidden' name='id' value='" . $row["id"] . "' />
                        <input type='submit' class='k' value='К1'>
                    </form>
            </td>";
			echo "<td class = marjin_left>
			<form action='help/delivery_2.php' method='post'>
				<input type='hidden' name='id' value='" . $row["id"] . "' />
				<input type='submit' class='k' value='К2'>
			</form>
	</td>";
