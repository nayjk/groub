	...
	<div class="wrapper">
		...
		<div class="content">
			<article class="main-article">
				...
				<a class="big dungeon_text10"> Список комментариев </a>
...
if($result = $conn->query($sql)){
    ...
    echo "<table>
            <tr>
                ...
                <th class = marjin_left>Комментарий</th>
                <th></th>
            </tr>";
            "<tr> </tr>";
    foreach($result as $row){
		...
		echo "<tr>";
		echo "<td>
		<form action='help/delete_comments.php' method='post'>
			<input type='hidden' name='id' value='" . $row["id"] . "' />
			<input type='submit' class = 'x'value='х'>
		</form>
	</td>";
            echo "<td class = marjin_left>" . $row["name"] . "</td>";
            echo "<td class = marjin_left>" . $row["contacts"] . "</td>";
            echo "<td class = marjin_left>" . $row["comments"] . "</td>";
        echo "</tr>";
    }
    echo "</table>";
	?> </div> <?php
