...
if(isset($_POST["id"])){
    ...
    if($conn->query($sql)){
        ...
        if(isset($_POST["id"])){
            ...
            $sql = "INSERT INTO orders_archive (name,phonenumber,date,time,orders,status,cost,adress) SELECT name,phonenumber,date,time,orders,status,cost,adress FROM orders WHERE id = '$userid'";
