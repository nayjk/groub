...
if(isset($_POST["id"])){
    ...
    if($conn->query($sql)){
        ...
        if(isset($_POST["id"])){
            ...
            $sql = "INSERT INTO reserv_done (date,time,guestcount,name,phonenumber,email,status) SELECT date,time,guestcount,name,phonenumber,email,status FROM reservation WHERE id = '$userid'";
